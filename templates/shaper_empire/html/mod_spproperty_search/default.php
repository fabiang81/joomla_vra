...
//$property_status = $input->get('property_status', NULL, 'STRING');
...
<div id="mod-sp-property-search<?php echo $module->id; ?>" class="sp-property-search <?php echo $params->get('moduleclass_sfx') ?>">
    <div class="row">
        ...
        <form class="spproperty-adv-search">
            <div class="col-sm-4 col-lg-2">
                <div class="keyword">
                    <input type="text" name="keyword" id="keyword" class="form-control" placeholder="<?php echo JText::_('Palabra Clave'); ?>" value="<?php echo $keyword; ?>">
                </div>
                <!--div class="status">
                    <div class="form-group">
                        <select name="status" id="status" class="form-control">
                            <option value="" <?php echo ($property_status == '') ? 'selected="selected"' : ''; ?>>
                                <?php echo JText::_('Tipo'); ?>
                            </option>
                            <?php foreach ($items as $status) { ?>
                                <option value="<?php echo $status->status; ?>" <?php echo ($property_status == $status->status) ? 'selected="selected"' : ''; ?>> <?php echo $status->status; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div-->
            ...
            <div class="col-sm-4 col-lg-2">
                <div class="min-price">
                    <input name="min-price" id="min-price" type="number" class="form-control" placeholder="<?php echo JText::_('Precio Mínimo'); ?>" value="<?php echo $min_price; ?>">
                </div>
            </div>
            <div class="col-sm-4 col-lg-2">
                <div class="max-price">
                    <input name="max-price" id="max-price" type="number" class="form-control" placeholder="<?php echo JText::_('Precio Máximo'); ?>" value="<?php echo $max_price; ?>">
                </div>
            </div>
            <div class="col-sm-4 col-lg-2">
                <div class="category">
    ...
    <!--div class="row">
        <div class="property-advance-search">
            <a href="#" data-toggle="modal" data-target=".sp-modal-lg"><i class="fa fa-plus-square"></i><span class="btn-text"><?php echo JText::_('Búsqueda Avanzada'); ?></span></a>
        </div>
    </div-->
</div>
<!-- Modal Content -->
                    ...
                    <div class="row">
                        <div class="sp-advance-search-wrap">
                            <div class="sp-advance-serach-title text-center">
                                ...
                                <h4><?php echo JText::_('Búsqueda Avanzada'); ?></h4>
                            </div>
                            <form class="spproperty-adv-search">
                                <div class="row">
                                    <div class="col-sm-4 col-lg-2">
                                        <div class="keyword">
                                            <input type="text" id="keyword" class="form-control" placeholder="<?php echo JText::_('Palabra Clave'); ?>" value="<?php echo $keyword; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-sm-4">
                                        <div class="zip-code">
                                            <input name="zip-code" id="zip-code" type="text" placeholder="<?php echo JText::_('Código Postal'); ?>" value="<?php echo $zipcode; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-lg-2">
                                        <div class="category">
                                    ...
                                    <div class="col-lg-2 col-sm-4">
                                        <div class="area">
                                            <input type="number" id="min-size" class="form-control" placeholder="<?php echo JText::_('Mínimo m²'); ?>" value="<?php echo $minsize; ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-sm-4">
                                        <div class="area">
                                            <input type="number" id="max-size" class="form-control" placeholder="<?php echo JText::_('Máximo m²'); ?>" value="<?php echo $maxsize; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-3 col-sm-4">
                                        <div class="bed">
                                            <select name="beds" id="beds" class="form-control">
                                                <option value="" <?php echo ($beds == '') ? 'selected="selected"' : ''; ?>><?php echo JText::_('No. de Habitaciones'); ?></option>

                                                <?php
                                                foreach ($numerics as $key => $numeric) {
                                                    $bed_text = ($key == 0) ? JText::_('') : JText::_('');
                                                    ?>
                                        ...
                                        <div class="bath">
                                            <select name="baths" id="baths" class="form-control">
                                                <option value="" <?php echo ($baths == '') ? 'selected="selected"' : ''; ?>>
                                                    <?php echo JText::_('No. de Baños'); ?>
                                                </option>

                                                <?php
                                                foreach ($numerics as $key => $numeric) {
                                                    $bath_text = ($key == 0) ? JText::_('') : JText::_('');
                                                    ?>
                                        ...
                                        <div class="parking">
                                            <select id="parking" class="form-control">
                                                <option value=""  <?php echo ($parking == '') ? 'selected="selected"' : ''; ?>>
                                                    <?php echo JText::_('Cajones estacionamiento'); ?>
                                                </option>

                                                <?php
                                                foreach ($numerics as $key => $numeric) {
                                                    $park_text = ($key == 0) ? JText::_('') : JText::_('');
                                                    ?>
                                    ...
                                    <div class="col-sm-4 col-lg-2">
                                        <div class="min-price">
                                            <input name="min-price" id="min-price" type="number" placeholder="<?php echo JText::_('Precio Mínimo'); ?>" value="<?php echo $min_price; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-lg-2">
                                        <div class="max-price">
                                            <input name="max-price" id="max-price" type="number" placeholder="<?php echo JText::_('Precio Máximo'); ?>" value="<?php echo $max_price; ?>">
                                        </div>
                                    </div>
