...
class SppagebuilderAddonPerson extends SppagebuilderAddons{
	...
	public function render() {
		...
		if($facebook || $twitter || $google_plus || $youtube || $linkedin || $pinterest || $flickr || $dribbble || $behance || $instagram) {
			...
			if($facebook) 		$social_icons .= '<li><a target="_blank" href="' . $facebook . '" class="facebook"><i class="fa fa-facebook"></i></a></li>';
			if($twitter) 		$social_icons .= '<li><a target="_blank" href="' . $twitter . '" class="twitter"><i class="fa fa-twitter"></i></a></li>';
			if($google_plus) 	$social_icons .= '<li><a target="_blank" href="' . $google_plus . '" class="google-plus"><i class="fa fa-google-plus"></i></a></li>';
